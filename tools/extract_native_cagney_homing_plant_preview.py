...
def default_bundle():
    ...
    raise FileNotFoundError(
        "Could not find atlas_flowerlevel; pass its location with --bundle."
    )


def parse_args():
    parser = argparse.ArgumentParser(
        description="Extract the native Cagney blue-seed catalog preview."
    )
    parser.add_argument("--bundle", type=Path, help="Path to atlas_flowerlevel.")
