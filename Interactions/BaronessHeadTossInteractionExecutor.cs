...
{
    internal sealed class BaronessHeadTossInteractionExecutor :
        ICreatorToolsInteractionExecutor
    {
        private readonly NativeBaronessHeadTossCache nativeCache;
        private readonly Func<bool> canSpawn;
        private readonly List<BaronessHeadTossInteractionState> activeStates =
            new List<BaronessHeadTossInteractionState>();

        internal BaronessHeadTossInteractionExecutor(
            ...
            Action<string> logWarning)
        {
            ...
            nativeCache = new NativeBaronessHeadTossCache(
                coroutineHost,
                canPreload,
                canSpawn,
                logInfo,
        ...
        public bool Supports(string item)
        {
            return string.Equals(
                item,
                CreatorToolsInteractionIds.BaronessHeadToss,
            ...
            out string error)
        {
            ...
            if (!Supports(item))
            {
                ...
                error = "The Baroness head toss executor does not support " +
                    item + ".";
                return false;
            }
            ...
            BaronessHeadTossInteractionState state;
