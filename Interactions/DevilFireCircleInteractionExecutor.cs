...
{
    internal sealed class DevilFireCircleInteractionExecutor :
        ICreatorToolsInteractionExecutor
    {
        private readonly NativeDevilFireCircleCache nativeCache;
        private readonly Func<bool> canSpawn;
        private readonly Action<string> logWarning;
        private readonly List<NativeDevilFireCircleSpawn> activeSpawns =
            new List<NativeDevilFireCircleSpawn>();

        internal DevilFireCircleInteractionExecutor(
            ...
            Action<string> logWarning)
        {
            ...
            nativeCache = new NativeDevilFireCircleCache(
                coroutineHost,
                canPreload,
                canSpawn,
                logInfo,
        ...
        public bool Supports(string item)
        {
            return string.Equals(
                item,
                CreatorToolsInteractionIds.DevilFireCircle,
            ...
            out string error)
        {
            ...
            if (!Supports(item))
            {
                ...
                error = "The Devil fire circle executor does not " +
                    "support " + item + ".";
                return false;
            }
            ...
            NativeDevilFireCircleSpawn spawned;
