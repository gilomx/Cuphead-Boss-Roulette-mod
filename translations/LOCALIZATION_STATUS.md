...
Hay 20 etiquetas, valores y confirmaciones del menú integrado que
deben traducirse a los 12 idiomas de Cuphead. Con los cinco retos nuevos, el
alcance público pendiente contiene **25 IDs**.
...
3. Mover los 25 IDs del juego al catálogo aprobado de cada idioma.
