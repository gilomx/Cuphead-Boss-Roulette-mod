...
| `ui.setting.difficulty` | SCHWIERIGKEIT |
| `ui.setting.challenge` | CHALLENGE |
| `ui.setting.auto_load` | AUTO-LADEN |
| `ui.value.enabled` | EIN |
| `ui.value.disabled` | AUS |
| `ui.value.enabled_feminine` | EIN |
| `ui.value.disabled_feminine` | AUS |
| `ui.difficulty.easy` | LEICHT |
| `ui.difficulty.normal` | NORMAL |
| `ui.difficulty.hard` | EXPERTE |
