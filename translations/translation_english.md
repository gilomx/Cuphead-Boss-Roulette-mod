...
| `ui.setting.difficulty` | DIFFICULTY |
| `ui.setting.challenge` | CHALLENGE |
| `ui.setting.auto_load` | AUTO-LOAD |
| `ui.value.enabled` | ON |
| `ui.value.disabled` | OFF |
| `ui.value.enabled_feminine` | ON |
| `ui.value.disabled_feminine` | OFF |
| `ui.difficulty.easy` | SIMPLE |
| `ui.difficulty.normal` | REGULAR |
| `ui.difficulty.hard` | EXPERT |
| `ui.action.spin` | SPIN! |
| `ui.action.play` | PLAY! |
| `ui.action.open_roulette` | OPEN ROULETTE |
| `ui.action.spin_again` | SPIN AGAIN |
| `ui.action.preparing` | PREPARING BATTLE... |
| `ui.action.spinning` | SPINNING... |
| `ui.challenge_prefix` | CHALLENGE: |
| `challenge.no_dash` | NO DASH |
| `challenge.no_mini_plane` | NO MINI-PLANE |
| `challenge.mini_plane_only` | MINI-PLANE ONLY |
| `challenge.no_bombs` | NO MINI-BOMBS |
| `challenge.no_peashooter` | NO PEASHOOTER |
| `challenge.no_ex` | NO EX |
| `challenge.black_and_white` | BLACK & WHITE |
