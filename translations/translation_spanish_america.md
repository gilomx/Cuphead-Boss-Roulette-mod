...
| `ui.slot.challenge` | RETO |
| `ui.setting.difficulty` | DIFICULTAD |
| `ui.setting.challenge` | RETO |
| `ui.setting.auto_load` | CARGA AUTOMÁTICA |
| `ui.value.enabled` | ACTIVADO |
...
| `ui.action.play` | ¡JUGAR! |
| `ui.action.open_roulette` | ABRIR RULETA |
| `ui.action.spin_again` | VOLVER A GIRAR |
